...
describe('AddingOrderInteractor', () => {
    ...
    it('available adding order command', () => {
        const availableAddOrderCommand = addingOrderInteractor.getAddingOrderCommand({
            shoppingBasket: {
                hasOrderItems: true,
                clear(): void {},
            },
    ...
    it('unavailable adding order command', () => {
        const unavailableAddOrderCommand = addingOrderInteractor.getAddingOrderCommand({
            shoppingBasket: {
                hasOrderItems: false,
                clear(): void {},
            },
